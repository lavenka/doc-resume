...
**Языки программирования**: java (с 2000), c++ (с 1996), javascript (с 2008), pascal (с 1988)

**Операционные системы**: linux (с 2008 (ubuntu), openSUSE с 2011), windows (с 1993), DOS (с 1988)
...
> Обычно на большинстве проектов я один занимался исправлением ошибок связанных с многопоточной работой в том числе с блокировками БД, обычно я один проводил крупные миграции, рефакторинг и чистку кода, обычно я один исправлял ошибки, связанные со стыками с DLL.
...
Приложения для генерации и отладки EJB.
...
##1993-1995 МГГУ, кафедра маркшейдерского дела и геологии
...
##1987-1992 Московский Приборостроительный Техникум, факультет программирования
